...
from expenses._settle import individual_statements
...
def test_debts() -> None:
    ...
    debts = individual_statements(expenses)
...
def test_weighted_debts() -> None:
    ...
    debts = individual_statements(expenses, weights=weights)
...
def test_sum_of_debts(expense_list: list[Expense]) -> None:
    ...
    debts = individual_statements(expense_list)
